            ...
            <ul class="navbar-nav mb-2 mb-lg-0 ms-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu border-0 shadow" style="right: 0; left: initial;">
                        ...
                        <li><a class="dropdown-item" href="{{ route('home') }}/usuarios">Usuários</a>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="{{ route('home') }}/logout">Sair</a></li>
                    </ul>
                </li>
            </ul>
            <form action="{{ route('home') }}" class="d-flex" method="GET" role="search">
                <input aria-label="Pesquisar" class="form-control me-2 shadow-none" name="pesquisa"
                    placeholder="Pesquisar" type="search" value="">
